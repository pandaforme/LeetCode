...
//    }
    ...
    public int leastInterval(char[] tasks, int n) {
        ...
        PriorityQueue<Map.Entry<Character, Integer>> queue = new PriorityQueue<>((e1, e2) -> Integer.compare(e2.getValue(), e1.getValue()));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Solution().leastInterval(new char[]{'A'}, 2));
    }
}
